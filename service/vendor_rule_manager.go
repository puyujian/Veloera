...
func (m *VendorRuleManager) loadDefaultRules() {
	defaultRules := []*VendorRule{
		...
		{ProviderID: "alibaba", DisplayName: "阿里巴巴", Pattern: regexp.MustCompile(`(?i)^(qwen|tongyi)`)},
		{ProviderID: "deepseek", DisplayName: "DeepSeek", Pattern: regexp.MustCompile(`(?i)^deepseek`)},
		{ProviderID: "moonshot", DisplayName: "Moonshot", Pattern: regexp.MustCompile(`(?i)^(moonshot|kimi)`)},
		{ProviderID: "zhipu", DisplayName: "智谱", Pattern: regexp.MustCompile(`(?i)^(glm|bigmodel)`)},
		{ProviderID: "baidu", DisplayName: "百度", Pattern: regexp.MustCompile(`(?i)^ernie`)},
		{ProviderID: "mistral", DisplayName: "MistralAI", Pattern: regexp.MustCompile(`(?i)^(mistral|ministral)`)},
		...
		{ProviderID: "minimax", DisplayName: "MiniMax", Pattern: regexp.MustCompile(`(?i)^minimax`)},
		{ProviderID: "opengvlab", DisplayName: "上海AI实验室", Pattern: regexp.MustCompile(`(?i)^(intern|compass)`)},
		{ProviderID: "stepfun", DisplayName: "阶跃星辰", Pattern: regexp.MustCompile(`(?i)^step`)},
	}
